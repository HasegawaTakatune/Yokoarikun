...
public class LeadControl : MonoBehaviour {
	//******************************************************************//
	//	キャラクター誘導の制御群	
	//	誘導するキャラクター数の制御は、任意のタイミングで出来るように、
	//	外部呼び出し用にする前提で作っています。
	//
	//	呼び出し関係図
	//	Start　───>UpdateTarget	───>Customers.SetAnimator
	//	当たり判定	───>OnCollisionEnter2D	─┬─>GetCustomers
	//										 └─>Hit				─┬─>RecieveInterface.ISnatched
	//															 └─>GetCustomers
	//******************************************************************//
	...
	[SerializeField] AudioSource audioSource;	// オーディオソース格納
	[SerializeField] AudioClip audioClip;		// オーディオクリップ格納
	...
	//	機能		:	誘導するキャラクターを指定された数確保する。外部参照用
	...
	//**************************************************************//
	//	関数名　:	DeleteCustomers
	//	機能		:	誘導している最後尾のキャラクターを削除する。外部参照用
	//	引数		:	なし
	//	戻り値	:	なし
	//**************************************************************//
